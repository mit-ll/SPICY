...
data NatMap__Map__Raw__R_mem elt =
 ...
 | NatMap__Map__Raw__R_mem_3 (NatMap__Map__Raw__Coq_t elt) Prelude.Int elt (([]) ((,) Prelude.Int elt)) Prelude.Bool (NatMap__Map__Raw__R_mem
                                                                                                                     elt)

_NatMap__Map__Raw__coq_R_mem_rect :: NatMap__Map__Raw__Coq_key -> ((NatMap__Map__Raw__Coq_t a1) -> () -> a2) -> ((NatMap__Map__Raw__Coq_t 
                                     a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2) ->
                                     ((NatMap__Map__Raw__Coq_t a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () ->
                                     a2) -> ((NatMap__Map__Raw__Coq_t a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () ->
                                     () -> Prelude.Bool -> (NatMap__Map__Raw__R_mem a1) -> a2 -> a2) -> (NatMap__Map__Raw__Coq_t a1) ->
...
_NatMap__Map__Raw__coq_R_mem_rect k f f0 f1 f2 _ _ r =
  case r of {
   ...
   NatMap__Map__Raw__R_mem_3 s k' _x l _res r0 -> f2 s k' _x l __ __ __ _res r0 (_NatMap__Map__Raw__coq_R_mem_rect k f f0 f1 f2 l _res r0)}

_NatMap__Map__Raw__coq_R_mem_rec :: NatMap__Map__Raw__Coq_key -> ((NatMap__Map__Raw__Coq_t a1) -> () -> a2) -> ((NatMap__Map__Raw__Coq_t 
                                    a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2) ->
                                    ((NatMap__Map__Raw__Coq_t a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2)
                                    -> ((NatMap__Map__Raw__Coq_t a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () ->
                                    Prelude.Bool -> (NatMap__Map__Raw__R_mem a1) -> a2 -> a2) -> (NatMap__Map__Raw__Coq_t a1) -> Prelude.Bool
                                    -> (NatMap__Map__Raw__R_mem a1) -> a2
_NatMap__Map__Raw__coq_R_mem_rec =
  _NatMap__Map__Raw__coq_R_mem_rect

_NatMap__Map__Raw__mem_rect :: NatMap__Map__Raw__Coq_key -> ((NatMap__Map__Raw__Coq_t a1) -> () -> a2) -> ((NatMap__Map__Raw__Coq_t a1) ->
                               Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2) -> ((NatMap__Map__Raw__Coq_t 
                               a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2) -> ((NatMap__Map__Raw__Coq_t
                               a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2 -> a2) ->
...
_NatMap__Map__Raw__mem_rec :: NatMap__Map__Raw__Coq_key -> ((NatMap__Map__Raw__Coq_t a1) -> () -> a2) -> ((NatMap__Map__Raw__Coq_t a1) ->
                              Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2) -> ((NatMap__Map__Raw__Coq_t a1) ->
                              Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2) -> ((NatMap__Map__Raw__Coq_t a1) ->
                              Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2 -> a2) -> (NatMap__Map__Raw__Coq_t 
                              a1) -> a2
_NatMap__Map__Raw__mem_rec =
  _NatMap__Map__Raw__mem_rect

_NatMap__Map__Raw__coq_R_mem_correct :: NatMap__Map__Raw__Coq_key -> (NatMap__Map__Raw__Coq_t a1) -> Prelude.Bool -> NatMap__Map__Raw__R_mem
                                        a1
_NatMap__Map__Raw__coq_R_mem_correct k s _res =
  unsafeCoerce _NatMap__Map__Raw__mem_rect k (\y _ z _ -> Logic.eq_rect_r Prelude.False (NatMap__Map__Raw__R_mem_0 y) z)
    (\y y0 y1 y2 _ _ _ z _ -> Logic.eq_rect_r Prelude.False (NatMap__Map__Raw__R_mem_1 y y0 y1 y2) z) (\y y0 y1 y2 _ _ _ z _ ->
    Logic.eq_rect_r Prelude.True (NatMap__Map__Raw__R_mem_2 y y0 y1 y2) z) (\y y0 y1 y2 _ _ _ y6 z _ ->
    Logic.eq_rect_r (_NatMap__Map__Raw__mem k y2) (NatMap__Map__Raw__R_mem_3 y y0 y1 y2 (_NatMap__Map__Raw__mem k y2)
      (y6 (_NatMap__Map__Raw__mem k y2) __)) z) s _res __
...
data NatMap__Map__Raw__R_find elt =
 ...
 | NatMap__Map__Raw__R_find_3 (NatMap__Map__Raw__Coq_t elt) Prelude.Int elt (([]) ((,) Prelude.Int elt)) (Prelude.Maybe elt) (NatMap__Map__Raw__R_find
                                                                                                                             elt)

_NatMap__Map__Raw__coq_R_find_rect :: NatMap__Map__Raw__Coq_key -> ((NatMap__Map__Raw__Coq_t a1) -> () -> a2) -> ((NatMap__Map__Raw__Coq_t 
                                      a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2) ->
                                      ((NatMap__Map__Raw__Coq_t a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () ->
                                      a2) -> ((NatMap__Map__Raw__Coq_t a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () ->
                                      () -> (Prelude.Maybe a1) -> (NatMap__Map__Raw__R_find a1) -> a2 -> a2) -> (NatMap__Map__Raw__Coq_t 
...
_NatMap__Map__Raw__coq_R_find_rect k f f0 f1 f2 _ _ r =
  case r of {
   ...
   NatMap__Map__Raw__R_find_3 s k' x s' _res r0 -> f2 s k' x s' __ __ __ _res r0 (_NatMap__Map__Raw__coq_R_find_rect k f f0 f1 f2 s' _res r0)}

_NatMap__Map__Raw__coq_R_find_rec :: NatMap__Map__Raw__Coq_key -> ((NatMap__Map__Raw__Coq_t a1) -> () -> a2) -> ((NatMap__Map__Raw__Coq_t 
                                     a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2) ->
                                     ((NatMap__Map__Raw__Coq_t a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () ->
                                     a2) -> ((NatMap__Map__Raw__Coq_t a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () ->
                                     () -> (Prelude.Maybe a1) -> (NatMap__Map__Raw__R_find a1) -> a2 -> a2) -> (NatMap__Map__Raw__Coq_t 
...
_NatMap__Map__Raw__find_rect :: NatMap__Map__Raw__Coq_key -> ((NatMap__Map__Raw__Coq_t a1) -> () -> a2) -> ((NatMap__Map__Raw__Coq_t a1) ->
                                Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2) -> ((NatMap__Map__Raw__Coq_t 
                                a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2) -> ((NatMap__Map__Raw__Coq_t
                                a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2 -> a2) ->
                                (NatMap__Map__Raw__Coq_t a1) -> a2
...
_NatMap__Map__Raw__find_rec :: NatMap__Map__Raw__Coq_key -> ((NatMap__Map__Raw__Coq_t a1) -> () -> a2) -> ((NatMap__Map__Raw__Coq_t a1) ->
                               Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2) -> ((NatMap__Map__Raw__Coq_t 
                               a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2) -> ((NatMap__Map__Raw__Coq_t
                               a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2 -> a2) ->
                               (NatMap__Map__Raw__Coq_t a1) -> a2
...
_NatMap__Map__Raw__coq_R_find_correct :: NatMap__Map__Raw__Coq_key -> (NatMap__Map__Raw__Coq_t a1) -> (Prelude.Maybe a1) ->
                                         NatMap__Map__Raw__R_find a1
_NatMap__Map__Raw__coq_R_find_correct k s _res =
  unsafeCoerce _NatMap__Map__Raw__find_rect k (\y _ z _ -> Logic.eq_rect_r Prelude.Nothing (NatMap__Map__Raw__R_find_0 y) z)
    (\y y0 y1 y2 _ _ _ z _ -> Logic.eq_rect_r Prelude.Nothing (NatMap__Map__Raw__R_find_1 y y0 y1 y2) z) (\y y0 y1 y2 _ _ _ z _ ->
    Logic.eq_rect_r (Prelude.Just y1) (NatMap__Map__Raw__R_find_2 y y0 y1 y2) z) (\y y0 y1 y2 _ _ _ y6 z _ ->
    Logic.eq_rect_r (_NatMap__Map__Raw__find k y2) (NatMap__Map__Raw__R_find_3 y y0 y1 y2 (_NatMap__Map__Raw__find k y2)
      (y6 (_NatMap__Map__Raw__find k y2) __)) z) s _res __

_NatMap__Map__Raw__add :: NatMap__Map__Raw__Coq_key -> a1 -> (NatMap__Map__Raw__Coq_t a1) -> NatMap__Map__Raw__Coq_t a1
...
data NatMap__Map__Raw__R_add elt =
 ...
 | NatMap__Map__Raw__R_add_3 (NatMap__Map__Raw__Coq_t elt) Prelude.Int elt (([]) ((,) Prelude.Int elt)) (NatMap__Map__Raw__Coq_t elt) 
...
_NatMap__Map__Raw__coq_R_add_rect :: NatMap__Map__Raw__Coq_key -> a1 -> ((NatMap__Map__Raw__Coq_t a1) -> () -> a2) ->
                                     ...
                                     a2) -> ((NatMap__Map__Raw__Coq_t a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () ->
                                     () -> a2) -> ((NatMap__Map__Raw__Coq_t a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () ->
                                     () -> () -> (NatMap__Map__Raw__Coq_t a1) -> (NatMap__Map__Raw__R_add a1) -> a2 -> a2) ->
                                     (NatMap__Map__Raw__Coq_t a1) -> (NatMap__Map__Raw__Coq_t a1) -> (NatMap__Map__Raw__R_add a1) -> a2
_NatMap__Map__Raw__coq_R_add_rect k x f f0 f1 f2 _ _ r =
  case r of {
   ...
   NatMap__Map__Raw__R_add_3 s k' y l _res r0 -> f2 s k' y l __ __ __ _res r0 (_NatMap__Map__Raw__coq_R_add_rect k x f f0 f1 f2 l _res r0)}

_NatMap__Map__Raw__coq_R_add_rec :: NatMap__Map__Raw__Coq_key -> a1 -> ((NatMap__Map__Raw__Coq_t a1) -> () -> a2) -> ((NatMap__Map__Raw__Coq_t
                                    a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2) ->
                                    ((NatMap__Map__Raw__Coq_t a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2)
                                    -> ((NatMap__Map__Raw__Coq_t a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () ->
                                    (NatMap__Map__Raw__Coq_t a1) -> (NatMap__Map__Raw__R_add a1) -> a2 -> a2) -> (NatMap__Map__Raw__Coq_t 
                                    a1) -> (NatMap__Map__Raw__Coq_t a1) -> (NatMap__Map__Raw__R_add a1) -> a2
_NatMap__Map__Raw__coq_R_add_rec =
  _NatMap__Map__Raw__coq_R_add_rect

_NatMap__Map__Raw__add_rect :: NatMap__Map__Raw__Coq_key -> a1 -> ((NatMap__Map__Raw__Coq_t a1) -> () -> a2) -> ((NatMap__Map__Raw__Coq_t 
                               a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2) -> ((NatMap__Map__Raw__Coq_t
                               a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2) -> ((NatMap__Map__Raw__Coq_t
                               a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2 -> a2) ->
                               (NatMap__Map__Raw__Coq_t a1) -> a2
...
_NatMap__Map__Raw__add_rec :: NatMap__Map__Raw__Coq_key -> a1 -> ((NatMap__Map__Raw__Coq_t a1) -> () -> a2) -> ((NatMap__Map__Raw__Coq_t 
                              a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2) -> ((NatMap__Map__Raw__Coq_t
                              a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2) -> ((NatMap__Map__Raw__Coq_t
                              a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2 -> a2) ->
                              (NatMap__Map__Raw__Coq_t a1) -> a2
...
_NatMap__Map__Raw__coq_R_add_correct :: NatMap__Map__Raw__Coq_key -> a1 -> (NatMap__Map__Raw__Coq_t a1) -> (NatMap__Map__Raw__Coq_t a1) ->
                                        NatMap__Map__Raw__R_add a1
_NatMap__Map__Raw__coq_R_add_correct k x s _res =
  _NatMap__Map__Raw__add_rect k x (\y _ z _ -> Logic.eq_rect_r ((:) ((,) k x) ([])) (NatMap__Map__Raw__R_add_0 y) z) (\y y0 y1 y2 _ _ _ z _ ->
    Logic.eq_rect_r ((:) ((,) k x) y) (NatMap__Map__Raw__R_add_1 y y0 y1 y2) z) (\y y0 y1 y2 _ _ _ z _ ->
    Logic.eq_rect_r ((:) ((,) k x) y2) (NatMap__Map__Raw__R_add_2 y y0 y1 y2) z) (\y y0 y1 y2 _ _ _ y6 z _ ->
    Logic.eq_rect_r ((:) ((,) y0 y1) (_NatMap__Map__Raw__add k x y2)) (NatMap__Map__Raw__R_add_3 y y0 y1 y2 (_NatMap__Map__Raw__add k x y2)
      (y6 (_NatMap__Map__Raw__add k x y2) __)) z) s _res __
...
data NatMap__Map__Raw__R_remove elt =
 ...
 | NatMap__Map__Raw__R_remove_3 (NatMap__Map__Raw__Coq_t elt) Prelude.Int elt (([]) ((,) Prelude.Int elt)) (NatMap__Map__Raw__Coq_t elt) 
 (NatMap__Map__Raw__R_remove elt)

_NatMap__Map__Raw__coq_R_remove_rect :: NatMap__Map__Raw__Coq_key -> ((NatMap__Map__Raw__Coq_t a1) -> () -> a2) -> ((NatMap__Map__Raw__Coq_t
                                        a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2) ->
                                        ((NatMap__Map__Raw__Coq_t a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () ->
                                        a2) -> ((NatMap__Map__Raw__Coq_t a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> ()
                                        -> () -> (NatMap__Map__Raw__Coq_t a1) -> (NatMap__Map__Raw__R_remove a1) -> a2 -> a2) ->
                                        (NatMap__Map__Raw__Coq_t a1) -> (NatMap__Map__Raw__Coq_t a1) -> (NatMap__Map__Raw__R_remove a1) -> a2
_NatMap__Map__Raw__coq_R_remove_rect k f f0 f1 f2 _ _ r =
  case r of {
   ...
   NatMap__Map__Raw__R_remove_3 s k' x l _res r0 -> f2 s k' x l __ __ __ _res r0 (_NatMap__Map__Raw__coq_R_remove_rect k f f0 f1 f2 l _res r0)}

_NatMap__Map__Raw__coq_R_remove_rec :: NatMap__Map__Raw__Coq_key -> ((NatMap__Map__Raw__Coq_t a1) -> () -> a2) -> ((NatMap__Map__Raw__Coq_t
                                       a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2) ->
                                       ((NatMap__Map__Raw__Coq_t a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () ->
                                       a2) -> ((NatMap__Map__Raw__Coq_t a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () ->
                                       () -> (NatMap__Map__Raw__Coq_t a1) -> (NatMap__Map__Raw__R_remove a1) -> a2 -> a2) ->
...
_NatMap__Map__Raw__remove_rect :: NatMap__Map__Raw__Coq_key -> ((NatMap__Map__Raw__Coq_t a1) -> () -> a2) -> ((NatMap__Map__Raw__Coq_t 
                                  a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2) ->
                                  ((NatMap__Map__Raw__Coq_t a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2)
                                  -> ((NatMap__Map__Raw__Coq_t a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2
...
_NatMap__Map__Raw__remove_rec :: NatMap__Map__Raw__Coq_key -> ((NatMap__Map__Raw__Coq_t a1) -> () -> a2) -> ((NatMap__Map__Raw__Coq_t 
                                 a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2) -> ((NatMap__Map__Raw__Coq_t
                                 a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2) -> ((NatMap__Map__Raw__Coq_t
                                 a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2 -> a2) ->
                                 (NatMap__Map__Raw__Coq_t a1) -> a2
...
_NatMap__Map__Raw__coq_R_remove_correct :: NatMap__Map__Raw__Coq_key -> (NatMap__Map__Raw__Coq_t a1) -> (NatMap__Map__Raw__Coq_t a1) ->
                                           NatMap__Map__Raw__R_remove a1
_NatMap__Map__Raw__coq_R_remove_correct k s _res =
  unsafeCoerce _NatMap__Map__Raw__remove_rect k (\y _ z _ -> Logic.eq_rect_r ([]) (NatMap__Map__Raw__R_remove_0 y) z)
    (\y y0 y1 y2 _ _ _ z _ -> Logic.eq_rect_r y (NatMap__Map__Raw__R_remove_1 y y0 y1 y2) z) (\y y0 y1 y2 _ _ _ z _ ->
...
data NatMap__Map__Raw__R_fold elt a =
 ...
 | NatMap__Map__Raw__R_fold_1 (NatMap__Map__Raw__Coq_t elt) a Prelude.Int elt (([]) ((,) Prelude.Int elt)) a (NatMap__Map__Raw__R_fold elt a)

_NatMap__Map__Raw__coq_R_fold_rect :: (NatMap__Map__Raw__Coq_key -> a1 -> a2 -> a2) -> ((NatMap__Map__Raw__Coq_t a1) -> a2 -> () -> a3) ->
                                      ((NatMap__Map__Raw__Coq_t a1) -> a2 -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> a2 ->
                                      (NatMap__Map__Raw__R_fold a1 a2) -> a3 -> a3) -> (NatMap__Map__Raw__Coq_t a1) -> a2 -> a2 ->
...
_NatMap__Map__Raw__coq_R_fold_rec :: (NatMap__Map__Raw__Coq_key -> a1 -> a2 -> a2) -> ((NatMap__Map__Raw__Coq_t a1) -> a2 -> () -> a3) ->
                                     ((NatMap__Map__Raw__Coq_t a1) -> a2 -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> a2 ->
                                     (NatMap__Map__Raw__R_fold a1 a2) -> a3 -> a3) -> (NatMap__Map__Raw__Coq_t a1) -> a2 -> a2 ->
                                     (NatMap__Map__Raw__R_fold a1 a2) -> a3
...
_NatMap__Map__Raw__fold_rect :: (NatMap__Map__Raw__Coq_key -> a1 -> a2 -> a2) -> ((NatMap__Map__Raw__Coq_t a1) -> a2 -> () -> a3) ->
                                ((NatMap__Map__Raw__Coq_t a1) -> a2 -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> a3 -> a3) ->
  ...
  Logic.eq_rect_r (case m of {
    ...
    (let {f2 = f0 m acc} in
     ...
     case m of {
      ...
      (:) p l ->
       case p of {
        (,) t0 e -> let {f4 = f3 t0 e l __} in let {hrec = _NatMap__Map__Raw__fold_rect f1 f0 f l (f1 t0 e acc)} in f4 hrec}})
    (_NatMap__Map__Raw__fold f1 m acc)

_NatMap__Map__Raw__fold_rec :: (NatMap__Map__Raw__Coq_key -> a1 -> a2 -> a2) -> ((NatMap__Map__Raw__Coq_t a1) -> a2 -> () -> a3) ->
                               ((NatMap__Map__Raw__Coq_t a1) -> a2 -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> a3 -> a3) ->
                               (NatMap__Map__Raw__Coq_t a1) -> a2 -> a3
_NatMap__Map__Raw__fold_rec =
  _NatMap__Map__Raw__fold_rect

_NatMap__Map__Raw__coq_R_fold_correct :: (NatMap__Map__Raw__Coq_key -> a1 -> a2 -> a2) -> (NatMap__Map__Raw__Coq_t a1) -> a2 -> a2 ->
                                         NatMap__Map__Raw__R_fold a1 a2
_NatMap__Map__Raw__coq_R_fold_correct f m acc _res =
  _NatMap__Map__Raw__fold_rect f (\y y0 _ z _ -> Logic.eq_rect_r y0 (NatMap__Map__Raw__R_fold_0 y y0) z) (\y y0 y1 y2 y3 _ y5 z _ ->
    Logic.eq_rect_r (_NatMap__Map__Raw__fold f y3 (f y1 y2 y0)) (NatMap__Map__Raw__R_fold_1 y y0 y1 y2 y3
      (_NatMap__Map__Raw__fold f y3 (f y1 y2 y0)) (y5 (_NatMap__Map__Raw__fold f y3 (f y1 y2 y0)) __)) z) m acc _res __

_NatMap__Map__Raw__equal :: (a1 -> a1 -> Prelude.Bool) -> (NatMap__Map__Raw__Coq_t a1) -> (NatMap__Map__Raw__Coq_t a1) -> Prelude.Bool
...
data NatMap__Map__Raw__R_equal elt =
 ...
 | NatMap__Map__Raw__R_equal_1 (NatMap__Map__Raw__Coq_t elt) (NatMap__Map__Raw__Coq_t elt) Prelude.Int elt (([]) ((,) Prelude.Int elt)) 
 Prelude.Int elt (([]) ((,) Prelude.Int elt)) Prelude.Bool (NatMap__Map__Raw__R_equal elt)
 | NatMap__Map__Raw__R_equal_2 (NatMap__Map__Raw__Coq_t elt) (NatMap__Map__Raw__Coq_t elt) Prelude.Int elt (([]) ((,) Prelude.Int elt)) 
 Prelude.Int elt (([]) ((,) Prelude.Int elt)) (OrderedType.Compare Prelude.Int)
 | NatMap__Map__Raw__R_equal_3 (NatMap__Map__Raw__Coq_t elt) (NatMap__Map__Raw__Coq_t elt) (NatMap__Map__Raw__Coq_t elt) (NatMap__Map__Raw__Coq_t
                                                                                                                         elt)

_NatMap__Map__Raw__coq_R_equal_rect :: (a1 -> a1 -> Prelude.Bool) -> ((NatMap__Map__Raw__Coq_t a1) -> (NatMap__Map__Raw__Coq_t a1) -> () -> ()
                                       -> a2) -> ((NatMap__Map__Raw__Coq_t a1) -> (NatMap__Map__Raw__Coq_t a1) -> Prelude.Int -> a1 -> (([])
                                       ((,) Prelude.Int a1)) -> () -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () ->
                                       Prelude.Bool -> (NatMap__Map__Raw__R_equal a1) -> a2 -> a2) -> ((NatMap__Map__Raw__Coq_t a1) ->
                                       (NatMap__Map__Raw__Coq_t a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> Prelude.Int
                                       -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> (OrderedType.Compare Prelude.Int) -> () -> () -> a2) ->
                                       ((NatMap__Map__Raw__Coq_t a1) -> (NatMap__Map__Raw__Coq_t a1) -> (NatMap__Map__Raw__Coq_t a1) -> () ->
                                       (NatMap__Map__Raw__Coq_t a1) -> () -> () -> a2) -> (NatMap__Map__Raw__Coq_t a1) ->
                                       (NatMap__Map__Raw__Coq_t a1) -> Prelude.Bool -> (NatMap__Map__Raw__R_equal a1) -> a2
...
_NatMap__Map__Raw__coq_R_equal_rec :: (a1 -> a1 -> Prelude.Bool) -> ((NatMap__Map__Raw__Coq_t a1) -> (NatMap__Map__Raw__Coq_t a1) -> () -> ()
                                      -> a2) -> ((NatMap__Map__Raw__Coq_t a1) -> (NatMap__Map__Raw__Coq_t a1) -> Prelude.Int -> a1 -> (([])
                                      ((,) Prelude.Int a1)) -> () -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () ->
                                      Prelude.Bool -> (NatMap__Map__Raw__R_equal a1) -> a2 -> a2) -> ((NatMap__Map__Raw__Coq_t a1) ->
                                      (NatMap__Map__Raw__Coq_t a1) -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> Prelude.Int ->
...
_NatMap__Map__Raw__equal_rect :: (a1 -> a1 -> Prelude.Bool) -> ((NatMap__Map__Raw__Coq_t a1) -> (NatMap__Map__Raw__Coq_t a1) -> () -> () ->
                                 a2) -> ((NatMap__Map__Raw__Coq_t a1) -> (NatMap__Map__Raw__Coq_t a1) -> Prelude.Int -> a1 -> (([])
                                 ((,) Prelude.Int a1)) -> () -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2 ->
                                 a2) -> ((NatMap__Map__Raw__Coq_t a1) -> (NatMap__Map__Raw__Coq_t a1) -> Prelude.Int -> a1 -> (([])
                                 ((,) Prelude.Int a1)) -> () -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> (OrderedType.Compare
                                 Prelude.Int) -> () -> () -> a2) -> ((NatMap__Map__Raw__Coq_t a1) -> (NatMap__Map__Raw__Coq_t a1) ->
...
_NatMap__Map__Raw__equal_rec :: (a1 -> a1 -> Prelude.Bool) -> ((NatMap__Map__Raw__Coq_t a1) -> (NatMap__Map__Raw__Coq_t a1) -> () -> () -> a2)
                                -> ((NatMap__Map__Raw__Coq_t a1) -> (NatMap__Map__Raw__Coq_t a1) -> Prelude.Int -> a1 -> (([])
                                ((,) Prelude.Int a1)) -> () -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> () -> () -> a2 -> a2)
                                -> ((NatMap__Map__Raw__Coq_t a1) -> (NatMap__Map__Raw__Coq_t a1) -> Prelude.Int -> a1 -> (([])
                                ((,) Prelude.Int a1)) -> () -> Prelude.Int -> a1 -> (([]) ((,) Prelude.Int a1)) -> () -> (OrderedType.Compare
                                Prelude.Int) -> () -> () -> a2) -> ((NatMap__Map__Raw__Coq_t a1) -> (NatMap__Map__Raw__Coq_t a1) ->
                                (NatMap__Map__Raw__Coq_t a1) -> () -> (NatMap__Map__Raw__Coq_t a1) -> () -> () -> a2) ->
...
_NatMap__Map__Raw__coq_R_equal_correct :: (a1 -> a1 -> Prelude.Bool) -> (NatMap__Map__Raw__Coq_t a1) -> (NatMap__Map__Raw__Coq_t a1) ->
                                          Prelude.Bool -> NatMap__Map__Raw__R_equal a1
_NatMap__Map__Raw__coq_R_equal_correct cmp m m' _res =
  _NatMap__Map__Raw__equal_rect cmp (\y y0 _ _ z _ -> Logic.eq_rect_r Prelude.True (NatMap__Map__Raw__R_equal_0 y y0) z)
    (\y y0 y1 y2 y3 _ y5 y6 y7 _ _ _ y11 z _ ->
    Logic.eq_rect_r ((Prelude.&&) (cmp y2 y6) (_NatMap__Map__Raw__equal cmp y3 y7)) (NatMap__Map__Raw__R_equal_1 y y0 y1 y2 y3 y5 y6 y7
      (_NatMap__Map__Raw__equal cmp y3 y7) (y11 (_NatMap__Map__Raw__equal cmp y3 y7) __)) z) (\y y0 y1 y2 y3 _ y5 y6 y7 _ y9 _ _ z _ ->
    Logic.eq_rect_r Prelude.False (NatMap__Map__Raw__R_equal_2 y y0 y1 y2 y3 y5 y6 y7 y9) z) (\y y0 y1 _ y3 _ _ z _ ->
    Logic.eq_rect_r Prelude.False (NatMap__Map__Raw__R_equal_3 y y0 y1 y3) z) m m' _res __
...
_NatMap__Map__Raw__mapi :: (NatMap__Map__Raw__Coq_key -> a1 -> a2) -> (NatMap__Map__Raw__Coq_t a1) -> NatMap__Map__Raw__Coq_t a2
...
_NatMap__Map__Raw__option_cons :: NatMap__Map__Raw__Coq_key -> (Prelude.Maybe a1) -> (([]) ((,) NatMap__Map__Raw__Coq_key a1)) -> ([])
...
_NatMap__Map__Raw__map2_l :: ((Prelude.Maybe a1) -> (Prelude.Maybe a2) -> Prelude.Maybe a3) -> (NatMap__Map__Raw__Coq_t a1) ->
                             NatMap__Map__Raw__Coq_t a3
_NatMap__Map__Raw__map2_l f m =
  case m of {
   ([]) -> ([]);
   (:) p l -> case p of {
               (,) k e -> _NatMap__Map__Raw__option_cons k (f (Prelude.Just e) Prelude.Nothing) (_NatMap__Map__Raw__map2_l f l)}}

_NatMap__Map__Raw__map2_r :: ((Prelude.Maybe a1) -> (Prelude.Maybe a2) -> Prelude.Maybe a3) -> (NatMap__Map__Raw__Coq_t a2) ->
                             NatMap__Map__Raw__Coq_t a3
_NatMap__Map__Raw__map2_r f m' =
  case m' of {
   ...
   (:) p l' ->
    case p of {
     (,) k e' -> _NatMap__Map__Raw__option_cons k (f Prelude.Nothing (Prelude.Just e')) (_NatMap__Map__Raw__map2_r f l')}}

_NatMap__Map__Raw__map2 :: ((Prelude.Maybe a1) -> (Prelude.Maybe a2) -> Prelude.Maybe a3) -> (NatMap__Map__Raw__Coq_t a1) ->
         ...
         case m' of {
          ...
          (:) p0 l' ->
           case p0 of {
            (,) k' e' ->
             case OrderedTypeEx._Nat_as_OT__compare k k' of {
              OrderedType.LT -> _NatMap__Map__Raw__option_cons k (f (Prelude.Just e) Prelude.Nothing) (_NatMap__Map__Raw__map2 f l m');
              OrderedType.EQ -> _NatMap__Map__Raw__option_cons k (f (Prelude.Just e) (Prelude.Just e')) (_NatMap__Map__Raw__map2 f l l');
              OrderedType.GT -> _NatMap__Map__Raw__option_cons k' (f Prelude.Nothing (Prelude.Just e')) (map2_aux l')}}}}
      in map2_aux}}

_NatMap__Map__Raw__combine :: (NatMap__Map__Raw__Coq_t a1) -> (NatMap__Map__Raw__Coq_t a2) -> NatMap__Map__Raw__Coq_t
           ...
           case p0 of {
            (,) k' e' ->
             case OrderedTypeEx._Nat_as_OT__compare k k' of {
              ...
              OrderedType.EQ -> (:) ((,) k ((,) (Prelude.Just e) (Prelude.Just e'))) (_NatMap__Map__Raw__combine l l');
...
_NatMap__Map__Raw__map2_alt :: ((Prelude.Maybe a1) -> (Prelude.Maybe a2) -> Prelude.Maybe a3) -> (NatMap__Map__Raw__Coq_t a1) ->
                               (NatMap__Map__Raw__Coq_t a2) -> ([]) ((,) NatMap__Map__Raw__Coq_key a3)
...
_NatMap__Map__Raw__at_least_one :: (Prelude.Maybe a1) -> (Prelude.Maybe a2) -> Prelude.Maybe ((,) (Prelude.Maybe a1) (Prelude.Maybe a2))
...
_NatMap__Map__Raw__at_least_one_then_f :: ((Prelude.Maybe a1) -> (Prelude.Maybe a2) -> Prelude.Maybe a3) -> (Prelude.Maybe a1) ->
...
type NatMap__Map__Coq_slist elt = NatMap__Map__Raw__Coq_t elt
...
_NatMap__Map__map2 :: ((Prelude.Maybe a1) -> (Prelude.Maybe a2) -> Prelude.Maybe a3) -> (NatMap__Map__Coq_t a1) -> (NatMap__Map__Coq_t 
                      a2) -> NatMap__Map__Coq_t a3
...
_NatMap__Map__equal :: (a1 -> a1 -> Prelude.Bool) -> (NatMap__Map__Coq_t a1) -> (NatMap__Map__Coq_t a1) -> Prelude.Bool
...
_NatMap__P__fold_rec :: (NatMap__Map__Coq_key -> a1 -> a2 -> a2) -> a2 -> (NatMap__Map__Coq_t a1) -> ((NatMap__Map__Coq_t a1) -> () -> a3) ->
                        (NatMap__Map__Coq_key -> a1 -> a2 -> (NatMap__Map__Coq_t a1) -> (NatMap__Map__Coq_t a1) -> () -> () -> () -> a3 -> a3)
                        -> a3
_NatMap__P__fold_rec f i m hempty hstep =
  Logic.eq_rect_r (List.fold_right (_NatMap__P__uncurry f) i (List.rev (_NatMap__Map__elements m)))
    (let {f0 = _NatMap__P__uncurry f} in
     ...
     let {hstep' = \k e a m' m'' x -> hstep (Datatypes.fst ((,) k e)) (Datatypes.snd ((,) k e)) a m' m'' __ __ __ x} in
       ...
       case a of {
        (,) k e ->
         hstep'0 k e (List.fold_right f0 i l0) (_NatMap__P__of_list l0) m0 __ __ __
           (iHl (\k0 e0 a0 m' m'' _ _ _ x -> hstep'0 k0 e0 a0 m' m'' __ __ __ x) __ (_NatMap__P__of_list l0) __)}) l (\k e a m' m'' _ _ _ x ->
       hstep' k e a m' m'' x) __ m __) (_NatMap__Map__fold f m i)

_NatMap__P__fold_rec_bis :: (NatMap__Map__Coq_key -> a1 -> a2 -> a2) -> a2 -> (NatMap__Map__Coq_t a1) -> ((NatMap__Map__Coq_t a1) ->
                            (NatMap__Map__Coq_t a1) -> a2 -> () -> a3 -> a3) -> a3 -> (NatMap__Map__Coq_key -> a1 -> a2 -> (NatMap__Map__Coq_t
                            a1) -> () -> () -> a3 -> a3) -> a3
...
_NatMap__P__fold_rec_nodep :: (NatMap__Map__Coq_key -> a1 -> a2 -> a2) -> a2 -> (NatMap__Map__Coq_t a1) -> a3 -> (NatMap__Map__Coq_key -> a1
                              -> a2 -> () -> a3 -> a3) -> a3
_NatMap__P__fold_rec_nodep f i m x x0 =
  _NatMap__P__fold_rec_bis f i m (\_ _ _ _ x1 -> x1) x (\k e a _ _ _ x1 -> x0 k e a __ x1)

_NatMap__P__fold_rec_weak :: (NatMap__Map__Coq_key -> a1 -> a2 -> a2) -> a2 -> ((NatMap__Map__Coq_t a1) -> (NatMap__Map__Coq_t a1) -> a2 -> ()
                             -> a3 -> a3) -> a3 -> (NatMap__Map__Coq_key -> a1 -> a2 -> (NatMap__Map__Coq_t a1) -> () -> a3 -> a3) ->
                             (NatMap__Map__Coq_t a1) -> a3
_NatMap__P__fold_rec_weak f i x x0 x1 m =
  _NatMap__P__fold_rec_bis f i m x x0 (\k e a m' _ _ x2 -> x1 k e a m' __ x2)

_NatMap__P__fold_rel :: (NatMap__Map__Coq_key -> a1 -> a2 -> a2) -> (NatMap__Map__Coq_key -> a1 -> a3 -> a3) -> a2 -> a3 ->
                        (NatMap__Map__Coq_t a1) -> a4 -> (NatMap__Map__Coq_key -> a1 -> a2 -> a3 -> () -> a4 -> a4) -> a4
      ...
      (let {l = List.rev (_NatMap__Map__elements m)} in
       ...
       Datatypes.list_rect (\_ -> rempty) (\a l0 iHl rstep'0 ->
         rstep'0 (Datatypes.fst a) (Datatypes.snd a) (List.fold_right (_NatMap__P__uncurry f) i l0)
           (List.fold_right (_NatMap__P__uncurry g) j l0) __ (iHl (\k e a0 b _ x -> rstep'0 k e a0 b __ x))) l (\k e a b _ x ->
         rstep' k e a b x)) (_NatMap__Map__fold g m j)) (_NatMap__Map__fold f m i)

_NatMap__P__map_induction :: ((NatMap__Map__Coq_t a1) -> () -> a2) -> ((NatMap__Map__Coq_t a1) -> (NatMap__Map__Coq_t a1) -> a2 ->
                             NatMap__Map__Coq_key -> a1 -> () -> () -> a2) -> (NatMap__Map__Coq_t a1) -> a2
_NatMap__P__map_induction x x0 m =
  _NatMap__P__fold_rec (\_ _ _ -> ()) () m x (\k e _ m' m'' _ _ _ x1 -> x0 m' m'' x1 k e __ __)

_NatMap__P__map_induction_bis :: ((NatMap__Map__Coq_t a1) -> (NatMap__Map__Coq_t a1) -> () -> a2 -> a2) -> a2 -> (NatMap__Map__Coq_key -> a1
                                 -> (NatMap__Map__Coq_t a1) -> () -> a2 -> a2) -> (NatMap__Map__Coq_t a1) -> a2
_NatMap__P__map_induction_bis x x0 x1 m =
  _NatMap__P__fold_rec_bis (\_ _ _ -> ()) () m (\m0 m' _ _ x2 -> x m0 m' __ x2) x0 (\k e _ m' _ _ x2 -> x1 k e m' __ x2)
...
_NatMap__P__filter :: (NatMap__Map__Coq_key -> a1 -> Prelude.Bool) -> (NatMap__Map__Coq_t a1) -> NatMap__Map__Coq_t a1
...
_NatMap__P__partition :: (NatMap__Map__Coq_key -> a1 -> Prelude.Bool) -> (NatMap__Map__Coq_t a1) -> (,) (NatMap__Map__Coq_t a1)
...
_NatMap__P__coq_Partition_In :: (NatMap__Map__Coq_t a1) -> (NatMap__Map__Coq_t a1) -> (NatMap__Map__Coq_t a1) -> NatMap__Map__Coq_key ->
                                Prelude.Bool
_NatMap__P__coq_Partition_In _ m1 _ k =
  _NatMap__P__F__coq_In_dec m1 k

_NatMap__P__update_dec :: (NatMap__Map__Coq_t a1) -> (NatMap__Map__Coq_t a1) -> NatMap__Map__Coq_key -> a1 -> Prelude.Bool
...
_NatMap__P__partition_dom :: (NatMap__Map__Coq_key -> Prelude.Bool) -> (NatMap__Map__Coq_t a1) -> (,) (NatMap__Map__Coq_t a1)
                             (NatMap__Map__Coq_t a1)
_NatMap__P__partition_dom f =
  _NatMap__P__partition (\k _ -> f k)

_NatMap__P__partition_range :: (a1 -> Prelude.Bool) -> (NatMap__Map__Coq_t a1) -> (,) (NatMap__Map__Coq_t a1) (NatMap__Map__Coq_t a1)
...
_NatMap__O__ME__lt_dec x y =
  OrderedType.coq_Compare_rec x y (\_ -> Prelude.True) (\_ -> Prelude.False) (\_ -> Prelude.False) (_NatMap__Map__E__compare x y)
...
_NatMap__O__P__fold_rec :: (NatMap__Map__Coq_key -> a1 -> a2 -> a2) -> a2 -> (NatMap__Map__Coq_t a1) -> ((NatMap__Map__Coq_t a1) -> () -> a3)
                           -> (NatMap__Map__Coq_key -> a1 -> a2 -> (NatMap__Map__Coq_t a1) -> (NatMap__Map__Coq_t a1) -> () -> () -> () -> a3
                           -> a3) -> a3
       ...
       case a of {
        (,) k e ->
         hstep'0 k e (List.fold_right f0 i l0) (_NatMap__O__P__of_list l0) m0 __ __ __
           (iHl (\k0 e0 a0 m' m'' _ _ _ x -> hstep'0 k0 e0 a0 m' m'' __ __ __ x) __ (_NatMap__O__P__of_list l0) __)}) l
       (\k e a m' m'' _ _ _ x -> hstep' k e a m' m'' x) __ m __) (_NatMap__Map__fold f m i)

_NatMap__O__P__fold_rec_bis :: (NatMap__Map__Coq_key -> a1 -> a2 -> a2) -> a2 -> (NatMap__Map__Coq_t a1) -> ((NatMap__Map__Coq_t a1) ->
                               (NatMap__Map__Coq_t a1) -> a2 -> () -> a3 -> a3) -> a3 -> (NatMap__Map__Coq_key -> a1 -> a2 ->
...
_NatMap__O__P__fold_rec_nodep :: (NatMap__Map__Coq_key -> a1 -> a2 -> a2) -> a2 -> (NatMap__Map__Coq_t a1) -> a3 -> (NatMap__Map__Coq_key ->
                                 a1 -> a2 -> () -> a3 -> a3) -> a3
_NatMap__O__P__fold_rec_nodep f i m x x0 =
  _NatMap__O__P__fold_rec_bis f i m (\_ _ _ _ x1 -> x1) x (\k e a _ _ _ x1 -> x0 k e a __ x1)

_NatMap__O__P__fold_rec_weak :: (NatMap__Map__Coq_key -> a1 -> a2 -> a2) -> a2 -> ((NatMap__Map__Coq_t a1) -> (NatMap__Map__Coq_t a1) -> a2 ->
                                () -> a3 -> a3) -> a3 -> (NatMap__Map__Coq_key -> a1 -> a2 -> (NatMap__Map__Coq_t a1) -> () -> a3 -> a3) ->
                                (NatMap__Map__Coq_t a1) -> a3
_NatMap__O__P__fold_rec_weak f i x x0 x1 m =
  _NatMap__O__P__fold_rec_bis f i m x x0 (\k e a m' _ _ x2 -> x1 k e a m' __ x2)

_NatMap__O__P__fold_rel :: (NatMap__Map__Coq_key -> a1 -> a2 -> a2) -> (NatMap__Map__Coq_key -> a1 -> a3 -> a3) -> a2 -> a3 ->
                           (NatMap__Map__Coq_t a1) -> a4 -> (NatMap__Map__Coq_key -> a1 -> a2 -> a3 -> () -> a4 -> a4) -> a4
      ...
      (let {l = List.rev (_NatMap__Map__elements m)} in
       ...
       Datatypes.list_rect (\_ -> rempty) (\a l0 iHl rstep'0 ->
         rstep'0 (Datatypes.fst a) (Datatypes.snd a) (List.fold_right (_NatMap__O__P__uncurry f) i l0)
           (List.fold_right (_NatMap__O__P__uncurry g) j l0) __ (iHl (\k e a0 b _ x -> rstep'0 k e a0 b __ x))) l (\k e a b _ x ->
         rstep' k e a b x)) (_NatMap__Map__fold g m j)) (_NatMap__Map__fold f m i)

_NatMap__O__P__map_induction :: ((NatMap__Map__Coq_t a1) -> () -> a2) -> ((NatMap__Map__Coq_t a1) -> (NatMap__Map__Coq_t a1) -> a2 ->
                                NatMap__Map__Coq_key -> a1 -> () -> () -> a2) -> (NatMap__Map__Coq_t a1) -> a2
_NatMap__O__P__map_induction x x0 m =
  _NatMap__O__P__fold_rec (\_ _ _ -> ()) () m x (\k e _ m' m'' _ _ _ x1 -> x0 m' m'' x1 k e __ __)

_NatMap__O__P__map_induction_bis :: ((NatMap__Map__Coq_t a1) -> (NatMap__Map__Coq_t a1) -> () -> a2 -> a2) -> a2 -> (NatMap__Map__Coq_key ->
                                    a1 -> (NatMap__Map__Coq_t a1) -> () -> a2 -> a2) -> (NatMap__Map__Coq_t a1) -> a2
_NatMap__O__P__map_induction_bis x x0 x1 m =
  _NatMap__O__P__fold_rec_bis (\_ _ _ -> ()) () m (\m0 m' _ _ x2 -> x m0 m' __ x2) x0 (\k e _ m' _ _ x2 -> x1 k e m' __ x2)
...
_NatMap__O__P__filter :: (NatMap__Map__Coq_key -> a1 -> Prelude.Bool) -> (NatMap__Map__Coq_t a1) -> NatMap__Map__Coq_t a1
...
_NatMap__O__P__partition :: (NatMap__Map__Coq_key -> a1 -> Prelude.Bool) -> (NatMap__Map__Coq_t a1) -> (,) (NatMap__Map__Coq_t a1)
                            (NatMap__Map__Coq_t a1)
...
_NatMap__O__P__coq_Partition_In :: (NatMap__Map__Coq_t a1) -> (NatMap__Map__Coq_t a1) -> (NatMap__Map__Coq_t a1) -> NatMap__Map__Coq_key ->
                                   Prelude.Bool
_NatMap__O__P__coq_Partition_In _ m1 _ k =
  _NatMap__O__P__F__coq_In_dec m1 k

_NatMap__O__P__update_dec :: (NatMap__Map__Coq_t a1) -> (NatMap__Map__Coq_t a1) -> NatMap__Map__Coq_key -> a1 -> Prelude.Bool
_NatMap__O__P__update_dec _ m' k _ =
  _NatMap__O__P__F__coq_In_dec m' k

_NatMap__O__P__filter_dom :: (NatMap__Map__Coq_key -> Prelude.Bool) -> (NatMap__Map__Coq_t a1) -> NatMap__Map__Coq_t a1
...
_NatMap__O__P__partition_dom :: (NatMap__Map__Coq_key -> Prelude.Bool) -> (NatMap__Map__Coq_t a1) -> (,) (NatMap__Map__Coq_t a1)
                                (NatMap__Map__Coq_t a1)
_NatMap__O__P__partition_dom f =
  _NatMap__O__P__partition (\k _ -> f k)

_NatMap__O__P__partition_range :: (a1 -> Prelude.Bool) -> (NatMap__Map__Coq_t a1) -> (,) (NatMap__Map__Coq_t a1) (NatMap__Map__Coq_t a1)
...
_NatMap__O__elements_lt :: ((,) NatMap__Map__Coq_key a1) -> (NatMap__Map__Coq_t a1) -> ([]) ((,) NatMap__Map__Coq_key a1)
_NatMap__O__elements_lt p m =
  List.filter (_NatMap__O__gtb p) (_NatMap__Map__elements m)

_NatMap__O__elements_ge :: ((,) NatMap__Map__Coq_key a1) -> (NatMap__Map__Coq_t a1) -> ([]) ((,) NatMap__Map__Coq_key a1)
...
_NatMap__O__map_induction_max :: ((NatMap__Map__Coq_t a1) -> () -> a2) -> ((NatMap__Map__Coq_t a1) -> (NatMap__Map__Coq_t a1) -> a2 ->
                                 Prelude.Int -> a1 -> () -> () -> a2) -> (NatMap__Map__Coq_t a1) -> a2
...
_NatMap__O__map_induction_min :: ((NatMap__Map__Coq_t a1) -> () -> a2) -> ((NatMap__Map__Coq_t a1) -> (NatMap__Map__Coq_t a1) -> a2 ->
                                 Prelude.Int -> a1 -> () -> () -> a2) -> (NatMap__Map__Coq_t a1) -> a2
